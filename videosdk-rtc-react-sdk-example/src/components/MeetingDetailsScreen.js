...
import { sendMeetingCode } from "./ParticipantGrid";


let storedCode;
export const getMeetingCode = (code) => {
...
export function MeetingDetailsScreen({
  ...
  //       console.log("Recived notificationnnnnnnnnnnnnnnn");  
  //       console.log("Meeting Id getting: ",payload?.notification?.body) 
  //     })
  //     .catch((err) => console.log('failed: ', err)); 
  //   }, [notification]);
  
const [meetingMi, setMeetingMi] = useState("");
useEffect(()=>{
 
  setMeetingMi( localStorage.getItem("mi"));
},
[])
...
if(meetingMi!=="" && meetingMi!==null && meetingMi!==undefined){
  ...
  console.log("meetingMi  ",meetingMi)
}
},
[meetingMi])
