...
function Videocall() {
  ...
  return authToken && meetingId ? (
    <MeetingProvider
      ...
      token={authToken}
    >
      <MeetingView className="meetingview" meetingId={meetingId} onMeetingLeave={onMeetingLeave} />
    </MeetingProvider>
  ) : (
    <JoinScreen className="meetingview" getMeetingAndToken={getMeetingAndToken} />
  );
}
